<?php 
    $faq = [
        ...
        //risposta
        [" <p id='paragrafo-margine'> Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose: </p>
...
<div class="wrapper">
    ...
    <h2> <?= $domanda; ?>
        ...
        <section>
            <?php foreach ($arrayRisposte as $risposta) {
            echo $risposta ?>
        </section>
    <?php }}; ?>
</div>  
